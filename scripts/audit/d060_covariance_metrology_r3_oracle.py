"""BD622 D-060 — covariance-metrology oracle, third issue (asymmetric r3).

Frozen contract: ``docs/audit/BD622_D060_covariance_metrology_contract_r3_2026-07-28.md``
...
Usage: PYTHONPATH=src venv/bin/python scripts/audit/d060_covariance_metrology_r3_oracle.py
...
def main(argv):
    ...
    try:
        ...
        report = {
            "contract": "BD622_D060_covariance_metrology_contract_r3_2026-07-28",
