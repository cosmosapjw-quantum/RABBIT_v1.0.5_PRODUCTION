"""Gold gate: Bianchi Type III orthogonal BBN cell."""
...
def test_typeIII_orthogonal_rejects_noncanonical_h_minus_one_data():
...
def test_typeIII_orthogonal_canonical_curvature_and_frame_change_yields():
    from rabbit.jax.driver_classB import JAXClassBConfig, run_classB_jax

    baseline_gold = _gold("classB_typeIII_N0_A1e5_sigma001")
    gold = _gold("classB_typeIII_N2_1em4_N3_m1em4_A1e5_sigma001")
