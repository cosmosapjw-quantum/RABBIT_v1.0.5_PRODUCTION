"""Gold gate: Bianchi Type VII_h tilted scalar h-locked BBN cell."""
...
def test_typeVIIh_tilted_requires_explicit_h():
...
def test_typeVIIh_tilted_rejects_wrong_h_relation():
    from rabbit.jax.run_tilted_bbn import TiltedBBNConfig
...
def test_typeVIIh_tilted_h_locked_curvature_frame_and_tilt_change_yields():
    from rabbit.jax.run_tilted_bbn import TiltedBBNConfig, run_tilted_bbn

    baseline_gold = _gold("tilted_typeVIIh_h0p5_N0_A1e5_sigma001_v1e7")
    gold = _gold("tilted_typeVIIh_h0p5_N2_5em4_N3_2p5em4_A1e5_sigma001_v1e7")
