"""Gold gate: Bianchi Type VI_h orthogonal h-locked BBN cell."""
...
def test_typeVIh_orthogonal_requires_explicit_h():
...
def test_typeVIh_orthogonal_rejects_wrong_h_relation():
    from rabbit.jax.driver_classB import JAXClassBConfig
...
def test_typeVIh_orthogonal_rejects_exceptional_minus_one_ninth_alias():
    from rabbit.jax.driver_classB import JAXClassBConfig
...
def test_typeVIh_orthogonal_h_locked_curvature_and_frame_change_yields():
    from rabbit.jax.driver_classB import JAXClassBConfig, run_classB_jax

    baseline_gold = _gold("classB_typeVIh_hm2_N0_A1e5_sigma001")
    gold = _gold("classB_typeVIh_hm2_N2_1em4_N3_m2em4_A1e5_sigma001")
